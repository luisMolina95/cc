...
avr-g++ ^
    ...
    -I"D:\Program Files (x86)\Arduino\hardware\WAV\avr\cores\lgt8f" ^
    -I"D:\Program Files (x86)\Arduino\hardware\WAV\avr\variants\lgt8fx8e" ^
    blink.cpp ^
    -o "build\null\detected.cpp"
...
avr-size -A "build\blink.elf" > "build\null\size.txt"
echo Done!